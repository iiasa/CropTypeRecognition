 ...
 */
public class CropDataSetIterator {

    private static final String DATA_DIR = "C:\\Users\\HP WorkStation\\Documents\\IIASA";
//    private static final String DATA_URL = "http://download.tensorflow.org/example_images/flower_photos.tgz";
    private static final String COP_DIR = DATA_DIR + "\\Image Dataset\\MWO";
    ...
    private static final Logger log = org.slf4j.LoggerFactory.getLogger(CropDataSetIterator.class);
...
//        File tarFile = new File(DATA_DIR, "imagenette2.tgz");
//        ArchiveUtils.unzipFileTo(tarFile.getAbsolutePath(), rootFile.getAbsolutePath());

        batchSize = batchSizeArg;
        File parentDir = new File(COP_DIR);
