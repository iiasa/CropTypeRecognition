...
// */
//
//public class TransferLearningModelTester extends Application {
//    DataNormalization trainImageScaler;
//    private static final Logger LOGGER = LoggerFactory.getLogger(TransferLearningModelTester.class);
//
...
//
//
//    ComputationGraph transferLearningModel; // trained model
...
//
//    public TransferLearningModelTester() throws IOException {
//
//
//    }
//
...
//
//        Layer[] layers = transferLearningModel.getLayers();
//        NeuralNetConfiguration ASDF = layers[0].conf();
//
...
//        Evaluation eval = transferLearningModel.evaluate(testIter);
...
//
//
//        transferLearningModel = ComputationGraph.load(model, true);
//        LOGGER.info("transferLearningModel retrieved" + transferLearningModel.summary());
//
...
//        //class 1
//        //ROC STATS
//        ROC roc = transferLearningModel.evaluateROC(testIter);
...
//
//        String defaultModelPath = TERMINAL_BASE_PATH + "\\Transfer Learning models\\12152020114018.zip";
//
...
//            INDArray[] outputPrediction = transferLearningModel.output(false,samples);
//
//            double maxIndex = -1;
//            double maxValue = -1;
//
...
//
//                double indArrayDouble = outputPrediction[0].getDouble(i);
//                if (indArrayDouble > maxValue) {
//                    maxValue = indArrayDouble;
//                    maxIndex = i;
//                }
//
//            }
//
//
//            System.out.println("PREDICTION = " + classLabels[(int) maxIndex]);
//            prediction = classLabels[(int) maxIndex];
//            probability = String.valueOf(maxValue * 100);
//
//        } catch (IOException e) {
//            e.printStackTrace();
//        }
...
//
//        String imagesPath = TERMINAL_BASE_PATH + "\\Image Dataset\\" + cropModelPrefix + "\\val";
