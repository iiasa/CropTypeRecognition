...
public class CropModelEnsambleFromTerminal {

    static DataNormalization trainImageScaler;
    private static final Logger LOGGER = LoggerFactory.getLogger(CropModelEnsambleFromTerminal.class);
        ...
        for (final File imgFile : dir.listFiles(IMAGE_FILTER)) {
            ...
            try {
                ...
                if (img != null) {
                    ...
                    System.out.println("MW: " + output2[0]);
