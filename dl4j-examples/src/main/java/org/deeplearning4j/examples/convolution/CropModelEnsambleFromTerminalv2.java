...
public class CropModelEnsambleFromTerminalv2 {

    static DataNormalization trainImageScaler;
    private static final Logger LOGGER = LoggerFactory.getLogger(CropModelEnsambleFromTerminalv2.class);
    ...
    private static final String PICTURE_PILE_BATCHES_PATH = PICTURE_PILE_PATH + "\\batches_v2";
...
//    private final double[][] centroids = {maizeCentroid, otherCentroid ,wheatCentroid};
    ...
    public static void main(String[] args) {
        ...
        String mwModelPath = TERMINAL_BASE_PATH + "\\Transfer Learning models\\crops\\12012022131936_RELU_MSE_E14_model.zip";
        ...
        for(int i = BATCH_INIT ; i < BATCH_END ; i++){
    ...
    static private void createPicturePileCSV(int batch) {
        ...
        for (final File imgFile : dir.listFiles(IMAGE_FILTER)) {
            ...
            try {
                ...
                System.out.println("batch: "+ batch+ ", image : " + imgFile.getName());
    ...
    static private void saveDatasetToCSV(String outputDataset, int batch) {

        String pattern = "MMddyyyyHHmmss";
        SimpleDateFormat simpleDateFormat = new SimpleDateFormat(pattern);
        String date = simpleDateFormat.format(new Date());
        String csvPath = TERMINAL_BASE_PATH + "\\cropModelEnsemble_2022Results\\cropModelEnsambleVal_"+ date +"_batch"+ batch+".csv";
